            ...
            {articles.map((article, index) => (
              ...
              >
                <motion.article
                  ...
                  whileHover={{ y: -5 }}
                  className="bg-slate-800/50 rounded-xl border border-slate-700 hover:border-slate-600 transition-all duration-300 overflow-hidden"
                >
